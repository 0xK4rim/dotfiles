...
Item {
    ...
    Component.onCompleted: {
        ...
        keymapsArray = [
            ...
            { "lhs": ":noh", "rhs": "Clear search highlighting untill the next search"},
            { "lhs": ":m[a-z][A-Z]", "rhs": "Put a marker between single file/multiple files"},
            { "lhs": "'[a-z][A-Z]", "rhs": "Move to the specified marker"},
            { "lhs": "'[a-z][A-Z]", "rhs": "Move to the specified marker"},
            { "lhs": "iB/b", "rhs": "Select the current curly braces/parantheses"},
            { "desc": ""},
